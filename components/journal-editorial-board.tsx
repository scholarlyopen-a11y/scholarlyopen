    ...
    <Card className={`border-none shadow-none bg-transparent relative flex flex-col items-center text-center p-2 ${
      ...
      {editor.imageUrl ? (
        <img 
          src={editor.imageUrl} 
          alt={editor.name} 
          className="h-32 w-32 rounded-full object-cover object-center shrink-0 mb-1" 
        />
      ) : (
        <div className="h-32 w-32 rounded-full flex items-center justify-center shrink-0 bg-secondary text-secondary-foreground font-bold mb-1">
